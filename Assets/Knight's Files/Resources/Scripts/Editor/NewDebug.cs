...
public class NewDebug : EditorWindow
{
    ...
    void StartDebug()
    {
        ...
        debugIcon = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Creations Law/Readme/Icons/Misc/Game Settings.png", typeof(Texture));
        controllerIcon = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Creations Law/Readme/Icons/Misc/Controller.png", typeof(Texture));
