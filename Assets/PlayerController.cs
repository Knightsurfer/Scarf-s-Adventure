...
public class PlayerController : MonoBehaviour {
    ...
    [Range(1f, 4f)] protected float m_GravityMultiplier = 2f;
    ...
    private void FixedUpdate()
    {
        ...
        bool crouch = Input.GetKey(KeyCode.Joystick1Button1);
